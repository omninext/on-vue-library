      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 21:
            ...
            getExampleLiveImports = function getExampleLiveImports(srci) {
              return (0, _getImports["default"])((0, _getScript["default"])(srci, config.jsxInExamples));
              ...
              if (example.type === 'code') {
                ...
                if (config.codeSplit) {
                  ...
                  if (process.env.NODE_ENV === 'production') {
                    ...
                    var compiledExample = (0, _vueInbrowserCompiler.compile)(example.content, _objectSpread(_objectSpread({}, config.compilerConfig), config.jsxInExamples ? {
                      jsx: '__pragma__(h)',
