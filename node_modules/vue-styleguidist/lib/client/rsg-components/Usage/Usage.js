...
export default function Usage(_ref) {
  ...
  if (slots && Object.keys(slots).length > 0) {
    slotsNode = slots && /*#__PURE__*/React.createElement(SlotsTable, {
      props: slots
    });
  }

  var propsNode = props && /*#__PURE__*/React.createElement(Props, {
    props: props
  });
  var eventsNode;

  if (events && Object.keys(events).length > 0) {
    eventsNode = events && /*#__PURE__*/React.createElement(Events, {
      props: events
    });
  }

  var methodsNode = methods && methods.length > 0 && /*#__PURE__*/React.createElement(Methods, {
    methods: methods
  });
