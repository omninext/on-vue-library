...
var Preview = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Preview, [{
    ...
    value: function executeCode() {
      ...
      try {
        var example = compile(code, _objectSpread(_objectSpread({}, this.context.config.compilerConfig), this.context.config.jsxInExamples ? {
          jsx: '__pragma__(h)',
      ...
      try {
        this.destroyVueInstance();
        this.vueInstance = new Vue(_objectSpread(_objectSpread({}, extendsComponent), rootComponent)).$mount(el);
      } catch (err) {
        this.handleError(err);
